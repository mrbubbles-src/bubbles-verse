...
│   ├── eslint-config/
│   └── typescript-config/
├── docs/                  # Monorepo docs, snapshots, and workflow artifacts
├── README.md
├── CHANGELOG.md
├── AGENTS.md
├── package.json
...
- Root repo docs: `README.md`, `CHANGELOG.md`, `docs/`
- App docs: `apps/*/README.md`, `apps/*/CHANGELOG.md`, optional `apps/*/docs/`
- Package docs: `packages/*/README.md`, `packages/*/CHANGELOG.md`, optional `packages/*/docs/`
