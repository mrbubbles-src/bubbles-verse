...
- `apps/dashboard/docs/dashboard-todo.md`
- `apps/dashboard/docs/assets/calm-creative-dashboard/dashboard-command-center-dark.png`
...
6. Whether to keep generated dashboard UI assets/mockups in
   `apps/dashboard/docs/assets/calm-creative-dashboard/` as canonical
   visual references.
