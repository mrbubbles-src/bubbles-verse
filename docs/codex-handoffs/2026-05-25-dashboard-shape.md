...
- `apps/dashboard/documentation/calm-creative-dashboard-visual-spec.md` - existing calm creative admin/content-studio direction and constraints.
- `apps/dashboard/documentation/dashboard-design-playbook.md` - existing route-by-route design rules and page directions.
- `apps/dashboard/documentation/dashboard-home-redesign-notes.md` - home route direction: flat editorial list, no card-heavy hero, command-center-ish layout.
- `apps/dashboard/documentation/dashboard-todo.md` - quick-start app selection future work.
