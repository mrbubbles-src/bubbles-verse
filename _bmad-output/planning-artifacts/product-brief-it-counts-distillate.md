---
title: 'Product Brief Distillate: It Counts'
type: llm-distillate
source: 'product-brief-it-counts.md'
created: '2026-04-06'
purpose: 'Token-efficient context for downstream PRD/development work'
---

# Product Brief Distillate: It Counts
...
- **Monorepo placement:** `apps/it-counts` in bubbles-verse
...
- **App name:** "It Counts" is the final name.
