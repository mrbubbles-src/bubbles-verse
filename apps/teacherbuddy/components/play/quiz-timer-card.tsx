...
import {
  ...
  PopoverContent,
  PopoverTrigger,
} from '@bubbles/ui/shadcn/popover';
import {
  Select,
  SelectContent,
  SelectItem,
...
export default function QuizTimerCard() {
  ...
  const toggleFavorite = useCallback((totalSeconds: number) => {
    setFavorites((prev) => {
      let next: number[];
            ...
            <div className="mt-2 flex items-center gap-2">
              <Select
                ...
                <SelectTrigger className="h-8 flex-1 text-sm">
                  <SelectValue>
                    {activePresetValue
                      ? formatPresetLabel(Number(activePresetValue))
                      : 'Custom time'}
                  </SelectValue>
                </SelectTrigger>
                <SelectContent>
          ...
          <div className="mt-4">
            ...
            <div className="mt-2 flex items-center gap-3">
              <input
                ...
                style={
                  {
                    '--slider-pct': `${Math.round(volume * 100)}%`,
