    ...
    <div className="space-y-5">
      <section className="space-y-1.5">
        <div className="flex items-center gap-2 text-primary">
          ...
          />
          <h3 className="text-lg/relaxed font-semibold">In a nutshell</h3>
        </div>
      ...
      <section className="space-y-1.5">
        <div className="flex items-center gap-2 text-primary">
          <HugeiconsIcon
            ...
            className="size-4 shrink-0"
          />
          <h3 className="text-lg/relaxed font-semibold">How to use it</h3>
        </div>
      ...
      <section className="space-y-1.5">
        <div className="flex items-center gap-2 text-primary">
          <HugeiconsIcon
            ...
            className="size-4 shrink-0"
          />
          <h3 className="text-lg/relaxed font-semibold">What you will get</h3>
        </div>
        <p className="text-base/relaxed text-pretty text-foreground/85 pl-6">
          {help.outcome}
        </p>
        ...
        <SheetHeader className="pr-12">
          <div className="flex items-center gap-2">
            ...
            <SheetTitle className="text-xl/relaxed font-bold">
              {isDashboard ? 'How TeacherBuddy Works' : currentPage.title}
            </SheetTitle>
          </div>
