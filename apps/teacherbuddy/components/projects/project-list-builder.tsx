...
import { Checkbox } from '@bubbles/ui/shadcn/checkbox';
import {
  Field,
  FieldContent,
  FieldDescription,
...
import { HugeiconsIcon, UserGroupIcon } from '@bubbles/ui/lib/hugeicons';
...
export default function ProjectListBuilder() {
  ...
  const handleCreateList = () => {
    if (!activeClassId) {
      const message =
        'Create and select a class before building a project list.';
      setError(message);
      toast.error(message);
      return;
    }
            ...
            <Field>
              ...
              <FieldContent>
                <Select
                  ...
                  <SelectContent>
                    <SelectItem value="none" className="text-base/relaxed">
                      Individual list
                    </SelectItem>
                    <SelectItem value="grouped" className="text-base/relaxed">
                      Create groups
                    </SelectItem>
                  </SelectContent>
                </Select>
