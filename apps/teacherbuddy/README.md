...
Source lives in **bubbles-verse** at `apps/teacherbuddy`. From the repo root:
...
Standalone clone of the app repo (if you use it): `git clone git@github.com:mrbubbles-src/teacherbuddy.git`.
