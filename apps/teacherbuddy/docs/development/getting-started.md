...
A guide for developers new to the TeacherBuddy codebase. For a full list of docs, see [README.md](../README.md).
...
2. Check related documentation in `docs/` ([README.md](../README.md))
...
See [metadata-and-seo.md](../operations/metadata-and-seo.md) for metadata details.
...
- **In-repo**: [docs/README.md](../README.md) – component reference, state, hooks, testing, conventions
