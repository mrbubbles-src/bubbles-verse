...
3. Expose the route in navigation (`sidebar`/header) and in [`routes.md`](../architecture/routes.md) if you maintain it.
...
- [routes.md](../architecture/routes.md) — URL inventory
- [structure.md](../architecture/structure.md) — where layout and providers live
- [App README](../../README.md) — env vars overview
