...
2. Check related documentation in `documentation/` ([README.md](README.md))
...
- **In-repo**: [documentation/README.md](README.md) – component reference, state, hooks, testing, conventions
