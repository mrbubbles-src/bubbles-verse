...
| Build differs locally vs CI | Env not listed in `turbo.json` — see [docs/tooling.md](../../../../docs/development/tooling.md). |

## Related docs

- App [README.md](../../README.md) — scripts and env list.
- **Root** [docs/architecture/monorepo.md](../../../../docs/architecture/monorepo.md) — monorepo boundaries.
